...
CSRF_TRUSTED_ORIGINS = ['self', 'glitchtip', env.str("GLITCHTIP_DOMAIN", "http://localhost:8000")]
...
ENABLE_OPEN_USER_REGISTRATION = env.bool("ENABLE_OPEN_USER_CORSTION", False)
